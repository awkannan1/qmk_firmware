...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN1] = LAYOUT_60_ansi(
    ...
    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, RGB_HUD, RGB_SAD, RGB_VAD, _______, _______, _______, _______,\
    BL_INC, BL_DEC, BL_TOGG, BL_BRTG, _______, _______, _______, _______, _______, _______, _______, _______, \
